            ...
            <div className="grid grid-rows-3 md:grid-rows-none md:grid-cols-3 justify-items-center">
                <Fade left>
                    <div className="flex flex-col">
                        <img className="object-cover p-14 pb-0" src="images/decor.jpg" alt="decor" />
                ...
                <Fade bottom>
                    <div className="flex flex-col">
                        <img className="object-cover w-full p-14 pb-0" src="images/floral.jpg" alt="decor" />
                ...
                <Fade right>
                    <div className="flex flex-col">
                        <img className="object-cover p-14 pb-0" src="images/gifts.jpg" alt="decor" />
