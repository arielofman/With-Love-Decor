        ...
        <div className="w-full h-96 lg:h-screen bg-center bg-cover bg-hero-pattern">
            <div className="flex flex-col h-full justify-center items-center">
                <Fade cascade>
                    ...
                    <div className="text-center font-formal-script text-4xl md:text-6xl text-slight-brown pb-3 md:pb-7">Decor</div>
                </Fade>
                <Bounce left>
                    <Link activeClass="active"
                        ...
                        <button className="bg-red-300 hover:bg-red-500 text-white text-xs md:text-base py-3 px-4 md:px-8 rounded-full focus:outline-none">
                            CONTACT US
                        </button>
                    </Link>
                </Bounce>
