...
function Specialize() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 py-10 md:py-20 bg-calm-peach">
            <Fade left>
                <img className="hidden md:block md:w-3/4 lg:w-8/12 h-auto justify-self-end pr-10" src="images/bouquet.jpg" alt="" />
            </Fade>
            <div className="mx-auto md:ml-0 flex flex-col justify-self-start text-center md:pl-10">
                <Fade top>
                ...
                <Fade right>
                    <div className="text-3xl md:text-4xl my-5 font-display-fair">we <span className="italic">specalize</span> in many fields</div>
                    <div className="flex ml-5 md:ml-0 mb-2">
                    ...
                    <Fade bottom>
                    <button
                        className="m-4 ml-5 md:ml-4  px-5 py-2 self-start bg-transparent hover:bg-black text-black font-lato tracking-widest hover:text-white border border-black hover:border-transparent">
                        MORE
                </button>
                </Fade>
            </div>
